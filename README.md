...
Тут я использовал тот же самый сайт, что и при выполнении задания 2. При выполнении Плейбука может быть ошибка проверке 443 порта, вызванная тем что сертификат самоподписной. Если бы сертификат был выдан lets encyrpt или другой проверенной организацией, то проблемы бы не было.
